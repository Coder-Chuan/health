...
public class MessageConstant {
    ...
    public static final String GET_CHECKITEMIDS_FAIL = "查询检查项id数据失败";
    public static final String GET_CHECKITEMIDS_SUCCESS = "查询检查项id数据成功";
}
